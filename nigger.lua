...
menuName = "iotsense" -- The name of the menu
...
Citizen.CreateThread(function()
    ...
    WarMenu.SetSubTitle('skid', 'yes rp bypassed')
    ...
    while true do
        ...
        elseif WarMenu.IsMenuOpened('self') then
			...
			elseif WarMenu.Button("~g~yes rp revive") then
			TriggerEvent('nigger_ambulancejob:niggerreviveblack', GetPlayerServerId(PlayerId()))
